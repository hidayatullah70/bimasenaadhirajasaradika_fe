/**
 * HRD Shell Layout — PT. BARAK IOMS
 * Tab navigation across HRD core functional modules:
 * Overview, Attendance Spreadsheet, Rekap Payroll Input, Monitoring Kontrak.
...
const TABS = [
  ...
  {
    to: '/ops/hrd/payroll-summary',
    label: 'Rekap Input Payroll',
    icon: Calculator,
    end: false,
  },
  {
    to: '/ops/hrd/contracts',
    label: 'Kontrak & Dokumen',
    icon: FileCheck2,
    end: false,
  },
];
