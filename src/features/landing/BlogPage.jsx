/**
 * Public Blog Page — PT. BARAK
 * Source of Truth: PRD Section 2.1 (Public Site) & Section 17 (CMS: Blog Articles).
 */
      ...
      <main className="pt-16">
        ...
        <section className="bg-ink py-20">
          <div className="w-full px-4 sm:px-6 lg:px-8 text-center">
            <span className="inline-block px-3 py-1 rounded-full text-xs font-semibold bg-accent-green/20 text-accent-green border border-accent-green/30 mb-3">
              Insight & Edukasi Outsourcing
            </span>
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Blog & Wawasan Industri
            </h1>
            <p className="text-white/70 max-w-2xl mx-auto text-sm sm:text-base">
              Tips praktis manajemen risiko fasilitas, panduan kepatuhan upah UMK, dan strategi efisiensi operasional tenaga kerja outsourcing.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-canvas">
          <div className="w-full px-4 sm:px-6 lg:px-8">
            {loading ? (
              <div className="py-16">
                <StateLoading message="Memuat artikel blog..." />
              </div>
            ) : articles.length === 0 ? (
              <div className="bg-surface rounded-xl border border-border p-12 text-center">
                <BookOpen className="w-12 h-12 text-muted mx-auto mb-3" />
                <h3 className="text-base font-bold text-ink">Belum ada artikel blog</h3>
                <p className="text-xs text-muted mt-1">Nantikan artikel menarik dari tim ahli kami.</p>
              </div>
            ) : (
                  ...
                  >
                    <div className="p-6">
                      <div className="flex items-center justify-between gap-2 mb-3">
                        <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-2.5 py-0.5 rounded-full bg-accent-green/10 text-accent-green">
