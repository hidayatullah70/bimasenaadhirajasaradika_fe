...
export function BackToTop() {
  ...
  return (
    ...
    >
      ...
      <ArrowUp className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 stroke-[3] text-brand-red transition-transform duration-200 group-hover:-translate-y-0.5 filter drop-shadow-[0_1.5px_2px_rgba(0,0,0,0.25)]" />
