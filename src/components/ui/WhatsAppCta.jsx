  ...
  return (
    <div className="fixed z-50 bottom-[4.75rem] right-5 sm:bottom-[6.5rem] sm:right-8">
      ...
      >
        ...
        <svg
          viewBox="0 0 24 24"
          className="w-6 h-6 sm:w-7 sm:h-7 fill-white filter drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] transition-transform duration-200 group-hover:scale-105"
