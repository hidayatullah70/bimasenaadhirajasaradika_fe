...
export const INITIAL_EMPLOYEES = [
  {
    id: 'emp-101',
    employee_no: 'BA-2024-001',
    nik: '3275011501920003',
    name: 'Ahmad Faisal',
    gender: 'Laki-laki',
    birth_date: '1992-01-15',
    ptkp_status: 'K1',
    bank_account: 'BCA 8830192831 a.n Ahmad Faisal',
    npwp: '09.254.629.8-407.000',
    address: 'Jl. Melati Raya No. 14 RT 03/RW 05, Kel. Kayuringin Jaya, Kec. Bekasi Selatan, Kota Bekasi 17144',
    placement_address: 'Gedung Graha Mandiri Tower A & B, Jl. Jend. Sudirman Kav. 54-55, Jakarta Selatan',
    ...
    email: 'ahmad.faisal@bimasenaadhirajasaradika.com',
    status: 'active',
    ...
    contractEnd: '2026-12-31',
    end_date: '2026-12-31',
    photo_url: '/assets/img/team/person-2.jpeg'
  },
  {
    id: 'emp-102',
    employee_no: 'BA-2024-002',
    nik: '3275042003950001',
    name: 'Bagus Setiawan',
    gender: 'Laki-laki',
    birth_date: '1995-03-20',
    ptkp_status: 'TK',
    bank_account: 'Mandiri 1320019283912 a.n Bagus Setiawan',
    npwp: '82.123.456.7-412.000',
    address: 'Jl. Cempaka Putih Tengah No. 42 RT 07/RW 02, Cempaka Putih, Jakarta Pusat 10510',
    placement_address: 'Gedung Graha Mandiri Tower A & B, Jl. Jend. Sudirman Kav. 54-55, Jakarta Selatan',
    service: 'Security & Guard Services',
    ...
    email: 'bagus.s@bimasenaadhirajasaradika.com',
    status: 'active',
    ...
    contractEnd: '2026-12-31',
    end_date: '2026-12-31',
    photo_url: '/assets/img/team/nazi.jpg'
  },
  {
    id: 'emp-103',
    employee_no: 'BA-2024-003',
    nik: '3216061002930004',
    name: 'Rudi Hermawan',
    gender: 'Laki-laki',
    birth_date: '1993-02-10',
    ptkp_status: 'K2',
    bank_account: 'BRI 034101002938531 a.n Rudi Hermawan',
    npwp: '75.432.198.6-431.000',
    address: 'Kp. Kaliabang Dukuh No. 88 RT 02/RW 09, Pejuang, Medan Satria, Kota Bekasi',
    placement_address: 'Central Distribution Hub Cikarang, Kawasan Industri MM2100 Blok B1-4, Cikarang Barat, Bekasi',
    ...
    email: 'rudi.h@bimasenaadhirajasaradika.com',
    status: 'active',
    ...
    contractEnd: '2026-12-31',
    end_date: '2026-12-31',
    photo_url: '/assets/img/team/person-4.jpeg'
  },
  {
    id: 'emp-104',
    employee_no: 'BA-2024-004',
    nik: '3171050104960002',
    name: 'Rini Hidayati',
    gender: 'Perempuan',
    birth_date: '1996-04-01',
    ptkp_status: 'K1',
    bank_account: 'BCA 5420918273 a.n Rini Hidayati',
    npwp: '91.876.543.2-014.000',
    address: 'Jl. Tebet Timur Dalam VI No. 25 RT 04/RW 06, Tebet, Jakarta Selatan 12820',
    placement_address: 'Graha Mandiri Commercial Hall, Jl. Jend. Sudirman Kav. 54-55, Jakarta Selatan',
    service: 'Commercial Cleaning Service',
    position: 'Team Leader Kebersihan',
    employment_type: 'tetap',
    siteName: 'Graha Mandiri Commercial Hall',
    clientName: 'PT Menara Graha Mandiri',
    phone: '+62 821-4455-6677',
    email: 'rini.h@bimasenaadhirajasaradika.com',
    status: 'active',
    ...
    contractEnd: '2026-12-31',
    end_date: '2026-12-31',
    photo_url: '/assets/img/team/intan.png'
  },
  {
    id: 'emp-105',
    employee_no: 'BA-2024-005',
    nik: '3276022001910005',
    name: 'Eko Wahyudi',
    gender: 'Laki-laki',
    birth_date: '1991-01-20',
    ptkp_status: 'K2',
    bank_account: 'BNI 0839201948 a.n Eko Wahyudi',
    npwp: '63.987.654.1-411.000',
    address: 'Jl. Kejayaan No. 17 RT 01/RW 03, Sukmajaya, Kota Depok 16412',
    placement_address: 'Super Indo Flagship Store Depok, Jl. Margonda Raya No. 120, Depok',
    service: 'Security & Guard Services',
    ...
    email: 'eko.w@bimasenaadhirajasaradika.com',
    status: 'active',
    ...
    contractEnd: '2026-12-31',
    end_date: '2026-12-31',
    photo_url: '/assets/img/team/person-3.jpeg'
  },
  {
    id: 'emp-106',
    employee_no: 'BA-2024-006',
    nik: '3275081505940003',
    name: 'Yusuf Maulana',
    gender: 'Laki-laki',
    birth_date: '1994-05-15',
    ptkp_status: 'TK',
    bank_account: 'BCA 7710294821 a.n Yusuf Maulana',
    npwp: '54.321.098.7-407.000',
    address: 'Jl. KH Noer Ali No. 33 RT 05/RW 02, Jakasampurna, Bekasi Barat',
    placement_address: 'Gedung Graha Mandiri Tower A & B, Jl. Jend. Sudirman Kav. 54-55, Jakarta Selatan',
    service: 'Valet & Parking Management',
    position: 'Koordinator Pos Masuk / Kasir',
    employment_type: 'kontrak',
    siteName: 'Gedung Graha Mandiri Tower A & B',
    clientName: 'PT Menara Graha Mandiri',
    phone: '+62 821-6677-8899',
    email: 'yusuf.m@bimasenaadhirajasaradika.com',
    status: 'active',
    ...
    contractEnd: '2026-12-31',
    end_date: '2026-12-31',
    photo_url: '/assets/img/team/person-7.jpeg'
  },
  {
    id: 'emp-107',
    employee_no: 'BA-2024-007',
    nik: '3216010106970002',
    name: 'Doni Saputra',
    gender: 'Laki-laki',
    birth_date: '1997-06-01',
    ptkp_status: 'TK',
    bank_account: 'Mandiri 1560018492019 a.n Doni Saputra',
    npwp: '43.210.987.6-432.000',
    address: 'Perum Grand Cikarang City Blok E5 No. 12, Karangraharja, Cikarang Utara',
    placement_address: 'Central Distribution Hub Cikarang, Kawasan Industri MM2100 Blok B1-4, Cikarang Barat, Bekasi',
    service: 'General Labor & Warehousing',
    ...
    email: 'doni.s@bimasenaadhirajasaradika.com',
    status: 'active',
    ...
    contractEnd: '2026-12-31',
    end_date: '2026-12-31',
    photo_url: '/assets/img/team/person-5.jpeg'
  },
  {
    id: 'emp-108',
    employee_no: 'BA-2024-008',
    nik: '3216031506980006',
    name: 'Tri Wahyuni',
    gender: 'Perempuan',
    birth_date: '1998-06-15',
    ptkp_status: 'K3',
    bank_account: 'BCA 6820193847 a.n Tri Wahyuni',
    npwp: '32.109.876.5-431.000',
    address: 'Jl. Sukaresmi No. 5 RT 02/RW 04, Cikarang Selatan, Kabupaten Bekasi',
    placement_address: 'Pabrik Perakitan Modul Surya, Kawasan EJIP Blok 5C, Cikarang Selatan',
    service: 'Office Support & Administration',
    position: 'Staff Administrasi Gudang',
    employment_type: 'kontrak',
    siteName: 'Pabrik Perakitan Modul Surya',
    clientName: 'PT Surya Elektronik Sentosa',
    phone: '+62 821-8899-0011',
    email: 'tri.w@bimasenaadhirajasaradika.com',
    status: 'active',
